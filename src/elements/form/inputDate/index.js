...
import formatDate from 'utilisasi/formatDate'
import iconCalendar from 'assets/images/icon/Icon_date.svg'
            ...
            <div className="input-group">
                <div className="input-group-prepend bg-gray-900">
                    <span className="input-group-text">
                        <img height="32px" width="32px" src={iconCalendar} alt="icon calendar" />
                    </span>
                </div>
                <input
                    readOnly
